# Решение домашнего задания по варианту 4 (Площадь треугольника)
## В [example.html](example.html) на объекте window функция traingleS считает площадь треугольника
Исходник функции лежит в shri-async-hw.js
